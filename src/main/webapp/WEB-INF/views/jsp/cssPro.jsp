<%-- 
    Document   : cssHeader
    Created on : 27/03/2017, 11:22 AM
    Author     : ES - Christian Gutierrez
--%>
    <%@ page session="false"%>
  ...
  <link href="<c:url value="/resources/css/dataTables.bootstrap4.min.css"/>" rel="stylesheet" type="text/css" />
